...
| 109      | p^(p\|~q\|r)^q^r    | 1+p+p\*q+r+q\*r+p\*q\*r    | 237      |                        | 1+p+p\*q+r+q\*r              |
| 110      | (~p&q&r)^q^r        | q+r+q\*r+p\*q\*r           | 238      |                        | q+r-q\*r                     |
| 111      | ~p\|(q^r)           | 1+p+p\*q+p\*r              | 239      |                        | 1+p+p\*q+p\*r+p\*q\*r        |
| 112      | p^(p&q&r)           | p\*(1+q\*r)                | 240      |                        | p                            |
| 113      | p^(~((p^q)\|(p^r))) | 1+q+p\*q+r+p\*r+q\*r       | 241      |                        | 1+q+p\*q+r+p\*r+q\*r+p\*q\*r |
| 114      | ((p^q)\|r)^q        | p+r+p\*r+q\*r              | 242      |                        | p+r+p\*r+q\*r+p\*q\*r        |
| 115      | (p&~r)\|~q          | 1+q+p\*q+p\*q\*r           | 243      |                        | 1+q+p\*q                     |
| 116      | (p\|q)^(q&r)        | p+q+p\*q+q\*r              | 244      |                        | p+q+p\*q+q\*r+p\*\*r         |
| 117      | (p&~q)\|~r          | 1+r+p\*r+p\*q\*r           | 245      |                        | 1+r+p\*r                     |
| 118      | (p\|q\|r)^(q&r)     | p+q+p\*q+r+p\*r+p\*q\*r    | 246      |                        | p+q+p\*q+r+p\*r              |
| 119      | ~(q&r)              | 1+q\*r                     | 247      |                        | 1+q\*r+p\*q\*r               |
| 120      | p^(q&r)             | p+q\*r                     | 248      |                        | p+q\*r+p\*q\*r               |
| 121      | p^(~p\|q\|r)^q^r    | 1+q+p\*q+r+p\*r+p\*q\*r    | 249      |                        | 1+q+p\*q+r+p\*r              |
| 122      | p^(p&~q&r)^r        | p+r+p\*r+p\*q\*r           | 250      |                        | p+r-p\*r                     |
| 123      | ~((p^q^r)&q)        | 1+q+p\*q+q\*r              | 251      |                        | 1+q+p\*q+q\*r+p\*q\*r        |
| 124      | p^(p&q&~r)^q        | p+q+p\*q+p\*q\*r           | 252      |                        | p+q-p\*q                     |
| 125      | (p^q)\|~r           | 1+r+p\*r+q\*r              | 253      |                        | 1+r+p\*r+q\*r+p\*q\*r        |
| 126      | (p^q)\|(p^r)        | p+q+p\*q+r+p\*r+q\*r       | 254      |                        | q+p\*(-1+q)\*(-1+r)+r-q\*r   |
